...
let myGreeting = new Greeting ('Molly', 'MA')
myGreeting.hello()
...
let yourBook = new Book ("The Unhoneymooners", "Christina Lauren");
...
class List {
  ...
  displayMovies(){
    ...
    for (let i = 0; i < this.movie.length; i++){
      movieInfo += 
      `${this.movie[i].title} by ${this.movie[i].director}. `
 }
    return movieInfo
      }
...
let movie1 = new Movie ("Jurrasic Park", "Steven Spielber")
